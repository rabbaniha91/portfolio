...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      'template_5fma4jh',
      {
        ...
        to_email: "hrabbaniha18@gmail.com",
        message: form.message
      },
      'UaCtfVdFH8FBkRVEy'
    ).then(() => {
      setLoading(false)
      alert("Thanks. your email recived.")
      setForm({
        name: '',
        email: '',
        message: ''
  ...
  return (
    <div className='flex flex-col-reverse xl:flex-row xl:mt-12 gap-7 overflow-hidden'>
      <motion.div
      ...
      >
        ...
        <form onSubmit={handleSubmit} ref={formRef} className='mt-12 flex flex-col gap-8'>
          ...
          <button type='submit'
           ...
           py-3 px-8 outline-none w-fit text-white font-bold shadow-md shadow-primary rounded-lg'
          >
